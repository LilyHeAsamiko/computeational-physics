            ...
            for line in lines:
                ...
                if len(tokens)>0:
                    ...
                    if spid.isdigit():
                        ...
                        elif len(tokens)==11 and self.name != 'stampede2' and self.name !='taito': # nersc squeue output
                            jid,uname,acc,jname,part,qos,nodes,tlimit,wtime,status,start_time = tokens
                        elif len(tokens)==11 and self.name != 'taito': 
                            jid,uname,acc,jname,reason,start_time,tmp1,tmp2,nodes,tmp3,tmp4 = tokens
...
Taito(        900,    2,    12,   64,  100,   'srun',   'sbatch',  'squeue', 'scancel')
